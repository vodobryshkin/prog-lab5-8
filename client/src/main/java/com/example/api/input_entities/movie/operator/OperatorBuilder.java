package com.example.api.input_entities.movie.operator;
...
import com.example.api.input_entities.movie.operator.eye_color.EyeColorBuilderDirector;
import com.example.api.input_entities.movie.operator.hair_color.HairColorBuilderDirector;
import com.example.api.input_entities.movie.operator.height.HeightBuilderDirector;
import com.example.api.input_entities.movie.operator.location.LocationBuilderDirector;
import com.example.api.input_entities.movie.operator.name.NameBuilderDirector;
import com.example.api.input_entities.movie.operator.nationality.NationalityBuilderDirector;
import com.example.api.input_entities.types_builder.PersonBuilder;
